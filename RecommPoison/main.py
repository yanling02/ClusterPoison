...
def parse_args():
    ...
    parser.add_argument('--reg_u', type=float, default=1E2,
    ...
    parser.add_argument('--m', type=int, default=304,
    ...
    parser.add_argument('--targetItem', type=int, default=5556,
...
if __name__ == '__main__':
    ...
    for i,step in enumerate(steps):
        ...
        poison_model=NeuMF(num_users+m0+s*i+step+1, num_items+1, mf_dim, layers).to(device)
